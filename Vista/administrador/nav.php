...
$largo = "height: 150vh;";
$archivos[0] = "formularioRegistrar.php";
...
$archivos[8] = "consultarMaterias.php";
$archivos[9] = "consultarAccesorios.php";
$archivos[10] = "consultarInventario.php";
            ...
            <div class="nano-content" >
                <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="bi bi-pen"></i> Registrar <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="<?php echo $archivos[0]?>">Usuarios</a></li>
                            <li><a href="<?php echo $archivos[1]?>">Pedido</a></li>
                            <li><a href="<?php echo $archivos[2]?>">Material / Accesorios</a></li>
                            <li><a href="<?php echo $archivos[3]?>">Inventario</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-sub-toggle"><i class="bi bi-search"></i> Consultar <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="<?php echo $archivos[4]?>">Usuarios</a></li>
                            <li><a href="<?php echo $archivos[5]?>">Clientes</a></li>
                            <li><a href="<?php echo $archivos[6]?>">Proveedores</a></li>
                            <li><a href="<?php echo $archivos[7]?>">Pedidos</a></li>
                            <li><a href="<?php echo $archivos[8]?>">Material</a></li>
                            <li><a href="<?php echo $archivos[9]?>">Accesorios</a></li>
                            <li><a href="<?php echo $archivos[10]?>">Inventario</a></li>
                        </ul>
                    </li>
