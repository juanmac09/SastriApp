...
if (isset($_SESSION["confirmarRegistro"])) {
  ...
  if ($_SESSION["confirmarRegistro"] == 1) {
    ...
    echo "
      <script>
        document.addEventListener('DOMContentLoaded', function() {
          swal('" . $_SESSION['mensaje'] . "', 'Por favor registre un pedido.', 'error');
        });
      </script>";
  }
}
...
<body>
      ...
      <div class="card" style="margin-left:12%; margin-right:3%;">
        <div class="bootstrap-data-table-panel">
          <div class="table-responsive">
            <center>
              <h1 class="h1Consultar">Consultar Clientes</h1>
            </center>
  ...
  <script src="../js/clientePedido.js"></script>
</body>
