...
<body>
            ...
            <div class="card" style="margin-left:12%; margin-right:3%;">
                <div class="bootstrap-data-table-panel">
                    <div class="table-responsive">
                        <center>
                            <h1 class="h1Consultar">Consultar Inventario</h1>
                        </center>
    ...
    <script src="../../dashboard/js/lib/bootstrap.min.js"></script>1
    ...
    <script src="../js/seguridadDeshabilitarInventario.js"></script>
    <?php
    if (isset($_SESSION["confirmarRegistro"])){
